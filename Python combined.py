...
user = "Rushil" # user name of mqtt broker is provided
password = "Rushil@1810" #password is provide
...
while(1):
    ...
    for i in result:
        if i[0] == mqttQuery: #if entered button name of remote is avalable the enter to the loop
            ...
            client.publish("Mydata", msg) #publish the hex data to the connected client
            client.loop_stop()
