...
const char* ssid = "Redmi_R";// provide default SSID to the noddemcu
const char* password = "123456789";// provide the password for the ssid declared above
...
{ 
  ...
  while (!client.connected()) // when client is not connected then will enter in loop
  {
    ...
    if (client.connect("6039dcf1-4241-45ff-bec3-219526bb0492","Rushil" , "Rushil@1810"))// Client ID, user name and password is declared of MQTT broker
